...
| `/sys/class/net/*/statistics` | Throughput / Data / Load | Rx/Tx rate shown in fixed `MB/s`, cumulative totals shown in fixed `GB`, plus link utilisation % when link speed is known; loopback (`lo`) excluded |
